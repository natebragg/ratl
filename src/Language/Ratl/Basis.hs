...
prims = makeProg [
    ...
    (V "+",     Native (Arrow (PairTy (NatTy, NatTy)) NatTy)                                 2 (arith (+))),
    (V "-",     Native (Arrow (PairTy (NatTy, NatTy)) NatTy)                                 2 (arith (-))),
    (V "*",     Native (Arrow (PairTy (NatTy, NatTy)) NatTy)                                 2 (arith (*))),
    (V "/",     Native (Arrow (PairTy (NatTy, NatTy)) NatTy)                                 2 divide),

    -- comparison operations
    (V "<",     Native (Arrow (PairTy (NatTy, NatTy)) BooleanTy)                             2 (cmp (<))),
    (V ">",     Native (Arrow (PairTy (NatTy, NatTy)) BooleanTy)                             2 (cmp (>))),
    (V "=",     Native (Arrow (PairTy (Tyvar "a", Tyvar "a")) BooleanTy)                     2 equal),

    -- list functions
    (V "null?", Native (Arrow (ListTy (Tyvar "a")) BooleanTy)                                1 null'),
    (V "cons",  Native (Arrow (PairTy (Tyvar "a", ListTy (Tyvar "a"))) (ListTy (Tyvar "a"))) 2 cons),
